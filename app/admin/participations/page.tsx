                    ...
                    <div className="flex flex-wrap gap-1">
                      {p.ticket_numbers && p.ticket_numbers.length > 0 ? (
                        p.ticket_numbers.map((n: number) => (
                          <span
                            key={n}
                            className="inline-flex items-center justify-center w-7 h-7 bg-primary-100 text-primary-700 rounded-lg text-xs font-bold"
                          >
                            {n}
                          </span>
                        ))
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                        statutBadge[p.statut] || "bg-gray-100 text-gray-600"
                      }`}
                    >
